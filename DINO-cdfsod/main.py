...
def build_model_main(args):
    ...
    print(MODULE_BUILD_FUNCS._module_dict)
...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=utils.collate_fn, num_workers=args.num_workers, drop_last=False)
    ...
    if (not args.resume) and args.pretrain_model_path:
        ...
        with open('ignored_keys.json', 'w') as f:
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator = evaluate(model_without_ddp, criterion, postprocessors,
